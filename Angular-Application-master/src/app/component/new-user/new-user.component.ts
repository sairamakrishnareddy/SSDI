...
export class NewUserComponent implements OnInit {
  ...
  toMinDate : any;
  tCity : any;
  fromPlaces = ['Charlotte','Raleigh','Greensboro','Durham','Cary','Wilmington','Greenville','Huntersville','Chapel Hill','Hickory'];
  toPlaces = ['Charlotte','Raleigh','Greensboro','Durham','Cary','Wilmington','Greenville','Huntersville','Chapel Hill','Hickory'];
  carNames = ['Hyundai Sonata','Ford Fusion','Chevrolet Malibu','Chevrolet Silverado','Toyota Corolla','Nissan Altima','Toyota Camry','Honda Civic','Ford F-Series Pickup','Honda Accord'];
