...
exports.upload = (req,res,next) => {
  ...
  form.on('fileBegin',(name,file) =>
  {
    ...
    file.path=`/Users/saianishchowdarybezawada/Downloads/Angular-Application-master/license-1/${file.name}`;
  })
  res.status(200).send(data);
}
...
exports.upload1 = (req,res,next) => {
  ...
  {
    file.name='file1.jpeg'
    file.path=`/Users/saianishchowdarybezawada/Downloads/Angular-Application-master/license-2/${file.name}`;
  })
  res.status(200).send(data);
}